...
export default function GridSmallBackground(props) {
  return (
    <div className="h-[40rem] max-sm:h-[25rem] w-full dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] relative flex items-center justify-center">
